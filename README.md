...
3. Ask me only for: my domain, my platform (netlify / vercel / cloudflare), and my
   Alchemy API key. Deploying headless to Cloudflare? Ask me for a CLOUDFLARE_API_TOKEN
   instead of trying a browser login.
