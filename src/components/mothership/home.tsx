      ...
      <section className="grid grid-cols-1 items-center gap-10 py-6 lg:grid-cols-12 lg:py-8">
        <div className="flex flex-col items-center text-center lg:col-span-6 lg:items-start lg:text-left">
          ...
          <h1 className="text-4xl font-black leading-[1.08] tracking-tighter text-white sm:text-5xl lg:text-6xl">
            {/* On phones the two sentences own a line each — "One token." /
                "Infinite apps." — instead of wrapping wherever the width runs
                out (which orphaned "apps." on its own line). They rejoin into
                one line from sm up, where there is room. */}
            <span className="lg:text-7xl xl:text-8xl">
              <span className="block sm:inline">One token.</span>{" "}
              <span className="block sm:inline">Infinite apps.</span>
            </span>
            <br />
